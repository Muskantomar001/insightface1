...
Original file is located at
    https://colab.research.google.com/drive/1ASAbImX8aLh-NO3UylQHByZvGdhteeMH
"""
...
!cp "/content/drive/My Drive/retinaface weights/mobilenet0.25_Final.pth" .

import os
os.chdir("/content/drive/My Drive/retinaface weights")
!ls

!cp "/content/loader.py" .

!cp "/content/image_aug.py" .
